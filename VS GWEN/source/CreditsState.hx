...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
				['GWENS XMAS CHEER'],
			['dunce cap',			'dunce',		'creator of mod', 									'https://twitter.com/DunceCap0', 		'0xFFFFBB1B'],
			['LoganMcOof',			'LoganMcOof',		'created the gf soundfont i used', 					'https://twitter.com/LoganMcOof', 		'0xFFFFFFFF'],
			['BigBombKitty',			'BigBombKitty',		'created the switch stage event', 					'https://github.com/BigBombKitty', 		'4494E6'],
			[''],
			['Psych Engine Team'],
