...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['GWENS XMAS CHEER by'], 45);
				// credTextShit.visible = true;
				case 2:
					addMoreText('dunce cap', 45);
				...
				case 7:
				createCoolText(['the coolest site', 'is']);
				...
				case 11:
					addMoreText('This game right below lmao', -60);
				...
				// credTextShit.text += '\nNight';
				case 18:
					addMoreText('CHEER'); // credTextShit.text += '\nFunkin';
