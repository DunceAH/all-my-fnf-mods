...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'street':
			{
				defaultCamZoom = 0.9;
						curStage = 'street';
						var bg:FlxSprite = new FlxSprite( -290.7, -330.75).loadGraphic(Paths.image('bg/street'));
			...
			defaultCamZoom = 0.9;
						curStage = 'sunset';
						var bg:FlxSprite = new FlxSprite( -290.7, -330.75).loadGraphic(Paths.image('bg/sunset'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
			...
			case 'night':
			{
				defaultCamZoom = 0.9;
				curStage = 'night';
				var bg:FlxSprite = new FlxSprite( -398.6, -398.6).loadGraphic(Paths.image('bg/night'));
				bg.antialiasing = true;
				bg.scrollFactor.set(0.9, 0.9);
				bg.active = false;
				add(bg);
			...
			case 'fly':
			{
			  defaultCamZoom = 0.9;
				curStage = 'fly';
				var BGfly:FlxSprite = new FlxSprite( -230,-376.85).loadGraphic(Paths.image('bg/BGfly'));
				BGfly.antialiasing = true;
				BGfly.scrollFactor.set(0.9, 0.9);
				BGfly.active = false;
				add(BGfly);
				
				var BGflyTex = Paths.getSparrowAtlas('bg/fly motions');

				BGfly = new FlxSprite( -150,-376.85);
				BGfly.frames = BGflyTex;
				BGfly.animation.addByPrefix('bop', 'fly motion0', 24, true);
				BGfly.animation.play('bop');
				BGfly.setGraphicSize(Std.int(BGfly.width * 0.9));
				BGfly.antialiasing = true;
				add(BGfly);

				var BGflyTex = Paths.getSparrowAtlas('bg/stars');

				BGfly = new FlxSprite( -150,-376.85);
				BGfly.frames = BGflyTex;
				BGfly.animation.addByPrefix('bop', 'stars20', 24, true);
				BGfly.animation.play('bop');
				BGfly.setGraphicSize(Std.int(BGfly.width * 0.9));
				BGfly.antialiasing = true;
				add(BGfly);

				//var BGflyTex = Paths.getSparrowAtlas('bg/clouds');

				//BGfly = new FlxSprite( -200.45,-506.85);
				//BGfly.frames = BGflyTex;
				//BGfly.animation.addByPrefix('bop', 'clouds0', 24, true);
				//BGfly.animation.play('bop');
				//BGfly.setGraphicSize(Std.int(BGfly.width * 0.9));
				//BGfly.antialiasing = true;
				//add(BGfly);
			...
			case 'secret':
			{ //yes im doing this dont judge
			defaultCamZoom = 0.9;
						curStage = 'secret';
						var bg:FlxSprite = new FlxSprite(140, 100).loadGraphic(Paths.image('bg/Rick-Astley-Never-Gonna-Give-You-Up'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
		...
		switch(curStage)
		{
			...
			case 'street':
				boyfriend.setPosition(790.1, 165.6);
				gf.setPosition(325.3, -149.15);
			...
			case 'night':
				boyfriend.setPosition(561.7, 0);
				gf.setPosition(325.3, -149.15);
				//MESS WITH
			case 'fly':
				boyfriend.setPosition(790, -100);
				gf.setPosition(999, 999);
	...
	override public function update(elapsed:Float)
	{
		...
		//mess with
		if (boyfriend.curCharacter == "bfgf-DUO-FLY"){
